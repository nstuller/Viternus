//------------------------------------------------------------------------------
// <copyright file="StringResourcescs" company="Microsoft">
...
namespace Viternus.Membership.Providers
{
  ...
  internal static class StringResources
  {
    ...
    internal const string RoleL2EProvider_description = "L2E role provider.";
    ...
    internal const string L2EError_Connection_String = "An error occurred while attempting to initialize an EntityConnection object. The value that was provided for the connection string may be wrong, or it may contain an invalid syntax.";
    internal const string SqlError_Connection_String = "An error occurred while attempting to initialize an SqlConnection object. The value that was provided for the connection string may be wrong, or it may contain an invalid syntax.";
    ...
    internal const string MembershipL2EProvider_description = "L2E membership provider.";
    ...
    internal const int Password_Max_Size = 128;
    internal const int Name_Max_Size = 256;
  }
}
